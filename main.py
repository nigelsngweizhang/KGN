...
def sortCountry(df):
  ...
  print("The follwing dataframe are read as follow: \n")

  select_country=(df[['Year','Month','United Kingdom','Germany','France','Italy','Netherlands','Greece','Belgium & Luxembourg','Switzerland','Austria','Scandinavia','CIS & Eastern Europe']][218:347])
